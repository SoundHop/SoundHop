...
namespace SoundHop.UI.Controls
{
    public sealed partial class HotkeyControl : UserControl
    {
        ...
        public SoundHop.Core.Models.Hotkey? Hotkey
        {
            get => (SoundHop.Core.Models.Hotkey?)GetValue(HotkeyProperty);
            set => SetValue(HotkeyProperty, value);
        }

        public static readonly Microsoft.UI.Xaml.DependencyProperty HotkeyProperty =
            Microsoft.UI.Xaml.DependencyProperty.Register("Hotkey", typeof(SoundHop.Core.Models.Hotkey), typeof(HotkeyControl), new Microsoft.UI.Xaml.PropertyMetadata(null, OnHotkeyChanged));
        ...
        private void Render()
        {
            ...
            if (Hotkey.Modifiers.HasFlag(SoundHop.Core.Models.KeyModifiers.Windows)) parts.Add("Win");
            if (Hotkey.Modifiers.HasFlag(SoundHop.Core.Models.KeyModifiers.Control)) parts.Add("Ctrl");
            if (Hotkey.Modifiers.HasFlag(SoundHop.Core.Models.KeyModifiers.Shift)) parts.Add("Shift");
            if (Hotkey.Modifiers.HasFlag(SoundHop.Core.Models.KeyModifiers.Alt)) parts.Add("Alt");
