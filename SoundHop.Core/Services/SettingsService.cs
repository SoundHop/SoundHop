...
namespace SoundHop.Core.Services
{
    public class SettingsService
    {
        ...
        private static readonly string SettingsFile = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "SoundHop", "settings.json");
        
        public class AppSettings
        {
            public List<string> FavoriteDeviceIds { get; set; } = new List<string>();
            public Dictionary<string, SoundHop.Core.Models.Hotkey> Hotkeys { get; set; } = new Dictionary<string, SoundHop.Core.Models.Hotkey>();
            ...
            public Dictionary<string, SoundHop.Core.Models.DeviceNameInfo> DeviceNameMapping { get; set; } = new Dictionary<string, SoundHop.Core.Models.DeviceNameInfo>();
        }
        ...
        public void MigrateDeviceSettings(string oldId, string newId, string displayName, string subName)
        {
            ...
            Settings.DeviceNameMapping[newId] = new SoundHop.Core.Models.DeviceNameInfo
            {
        ...
        public void UpdateDeviceNameMapping(string deviceId, string displayName, string subName)
        {
            ...
            Settings.DeviceNameMapping[deviceId] = new SoundHop.Core.Models.DeviceNameInfo
            {
                DisplayName = displayName,
                SubName = subName
            };
        ...
        /// </summary>
        public SoundHop.Core.Models.DeviceNameInfo? GetDeviceNameInfo(string deviceId)
        {
